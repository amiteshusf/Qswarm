"""Versioned change plan snapshot for an automation session."""
...
class AutomationPlanVersion(Base):
    ...
    session: Mapped["AutomationSession"] = relationship("AutomationSession", back_populates="plan_versions")
    revision_round: Mapped["AutomationRevisionRound"] = relationship(
        "AutomationRevisionRound", back_populates="plan_versions"
    )
